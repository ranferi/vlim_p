 ...
 * TipoProductos Model
 *
 * @property \Cake\ORM\Association\HasMany $CategoriaProductos
 ...
 * @method \App\Model\Entity\TipoProducto findOrCreate($search, callable $callback = null)
 *
...
class TipoProductosTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->hasMany('CategoriaProductos', [
