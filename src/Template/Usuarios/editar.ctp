...
<?php $this->Html->addCrumb('Editar', ['controller' => 'Usuarios', 'action' => 'editar']); ?>
<div class="row-fluid">
    <div class="span12">
        <div class="da-panel collapsible">
            <div class="da-panel-header">
                <span class="da-panel-title"><i class="icol-pencil"></i> <?= __('Editar Usuario # ') .  h($usuario->id) ?></span>
                ...
                <div class="btn-toolbar">
                    <div class="btn-group">
                        <?= $this->Html->link('<i class="icol-magnifier"></i> ' . __('Ver'),
                            ['action' => 'ver', $usuario->id], ['class' => 'btn', 'escape' => false]) ?>
