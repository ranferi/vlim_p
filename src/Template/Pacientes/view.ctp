...
<div class="pacientes view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th scope="row"><?= __('Calle Numero') ?></th>
        ...
        <tr>
            <th scope="row"><?= __('Id Freestep') ?></th>
        ...
        <tr>
            <th scope="row"><?= __('Recibir Notificacion') ?></th>
            <td><?= $paciente->recibir_notificacion ? __('Yes') : __('No'); ?></td>
        </tr>
    </table>
    <div class="row">
        <h4><?= __('Patología') ?></h4>
        <?= $this->Text->autoParagraph(h($paciente->patología)); ?>
    </div>
    <div class="related">
