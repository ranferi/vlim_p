...
<?php $this->Html->addCrumb('Editar', ['controller' => 'Recubrimientos', 'action' => 'editar']); ?>
<div class="row-fluid">
    <div class="span12">
        <div class="da-panel collapsible">
            <div class="da-panel-header">
                <span class="da-panel-title"><i class="icol-pencil"></i> <?= __('Editar Recubrimiento # ') . h($recubrimiento->id) ?></span>
                ...
                <div class="btn-toolbar">
                    <div class="btn-group">
                        <?= $this->Html->link('<i class="icol-magnifier"></i> ' . __('Ver'),
                            ['action' => 'ver', $recubrimiento->id], ['class' => 'btn', 'escape' => false]) ?>
            ...
            <div class="da-panel-content da-form-container">
                ...
                <?= $this->Form->create($recubrimiento, ['class' => 'da-form']) ?>
