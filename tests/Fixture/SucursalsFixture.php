 ...
 *
 */
class SucursalsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nombre_sucursal' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'colonia' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'plataforma' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'software_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'escaner' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'ped_a_dist_lue_conf' => ['type' => 'string', 'length' => 5, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'nombre_sucursal' => 'Lorem ipsum dolor sit amet',
            ...
            'software_id' => 1,
            'escaner' => 'Lorem ipsum dolor sit amet',
            'telefono' => 'Lorem ipsum d',
            'empresa_id' => 1,
            'ped_a_dist_lue_conf' => 'Lor',
            'created' => '2016-09-20 17:41:25',
            'modified' => '2016-09-20 17:41:25'
        ],
    ];
}
