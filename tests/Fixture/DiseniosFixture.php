 ...
 *
 */
class DiseniosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'disenio' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'disenio' => 'Lorem ipsum dolor sit amet',
            'usuario_id' => 1,
            'paciente_id' => 1,
            'pedido_id' => 1,
            'created' => '2016-09-22 20:07:47',
            'modified' => '2016-09-22 20:07:47'
        ],
    ];
}
