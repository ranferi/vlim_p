...
class ProductosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'precio' => ['type' => 'decimal', 'length' => 7, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        'categoria_producto_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-09-23 18:38:34',
            'modified' => '2016-09-23 18:38:34'
        ],
    ];
}
