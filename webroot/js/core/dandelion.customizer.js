	...
	Customizer.prototype = {
		defaults: {
			...
			backgroundPatterns: {
				blueprint: {
					name: 'Blueprint', 
					file: 'assets/img/bg/blueprint.png'
				}, 
				bricks: {
					name: 'Bricks', 
					file: 'assets/img/bg/bricks.png'
				}, 
				carbon: {
					name: 'Carbon', 
					file: 'assets/img/bg/carbon.png'
				}, 
				circuit: {
					name: 'Circuit', 
					file: 'assets/img/bg/circuit.png'
				}, 
				holes: {
					name: 'Holes', 
					file: 'assets/img/bg/holes.png'
				}, 
				mozaic: {
					name: 'Mozaic', 
					file: 'assets/img/bg/mozaic.png'
				}, 
				roof: {
					name: 'Roof', 
					file: 'assets/img/bg/roof.png'
				}, 
				stripes: {
					name: 'Stripes', 
					file: 'assets/img/bg/stripes.png'
				}
			}, 
			headerPatterns: {
				carbon: {
					name: 'Carbon', 
					file: 'assets/img/headers/carbon.png'
				}, 
				linen: {
					name: 'Linen', 
					file: 'assets/img/headers/linen.png'
				}, 
				leather: {
					name: 'Leather', 
					file: 'assets/img/headers/leather.png'
				}, 
				wood: {
					name: 'Wood', 
					file: 'assets/img/headers/wood.png'
				}
			}
		}, 
